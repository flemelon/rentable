...
@RestController
@RequestMapping("/api/dms-kafka")
public class DmsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DmsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DmsKafkaResource(KafkaProperties kafkaProperties) {
